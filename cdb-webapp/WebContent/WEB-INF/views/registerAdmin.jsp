	...
	<div class="limiter">
		<div class="container-login100"
			...
			<div class="wrap-login100 p-t-190 p-b-30">
				<form:form id="registerForm" action="RegisterAdmin" method="POST" modelAttribute="user" class="login100-form validate-form">
					<div class="login100-form-avatar">
						<img src="img/register.png" alt="REGISTER">
					</div>

					<span class="login100-form-title p-t-20 p-b-45"> <spring:message
							code="label.createAdmin" />
					</span>

					<div class="wrap-input100 validate-input m-b-10"
						data-validate="Username is required">
						<spring:message	code="login.adminname" var="namePlaceholder"/>
					...
					<div class="container-login100-form-btn p-t-10">
						...
						<a href="javascript:history.back()" class="login100-form-btn register-form-btn register-form-btn-cancel"><spring:message code="label.cancelBtn"/></a>
					</div>
				</form:form>
			</div>
		</div>
