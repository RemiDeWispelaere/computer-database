	...
	<div class="limiter">
		<div class="container-login100"
			...
			<div class="wrap-login100 p-t-190 p-b-30">
				<form:form id="loginForm" action="loginAction" method="POST" modelAttribute="user" class="login100-form validate-form">
					...
					<div class="container-login100-form-btn" style="margin: 0px;">
						<a class="txt1" href="Register"> <spring:message
							code="login.create" /> <i
